...
export default function Pricing() {
  return (
    <div className="animate-fade-in">
      <header className="pt-32 pb-16 px-4 text-center max-w-3xl mx-auto">
        <h1 className="text-5xl md:text-6xl font-bold tracking-tighter mb-6">Simple, transparent pricing.</h1>
        <p className="text-xl text-muted-foreground font-mono text-sm md:text-base leading-relaxed">
      ...
      <section className="container mx-auto px-4 max-w-5xl mb-24">
        <div className="grid md:grid-cols-3 gap-6">
          <div className="p-8 rounded-xl border border-border bg-card flex flex-col">
            ...
            <div className="text-4xl font-bold mb-6 font-mono">$0<span className="text-lg text-muted-foreground font-sans font-normal">/mo</span></div>
          ...
          <div className="p-8 rounded-xl border-2 border-primary bg-primary/5 flex flex-col relative">
            ...
            <div className="text-4xl font-bold mb-6 font-mono">$20<span className="text-lg text-muted-foreground font-sans font-normal">/mo</span></div>
            <ul className="space-y-3 mb-8 flex-1 text-sm font-mono text-muted-foreground">
              <li className="flex gap-2"><Check className="w-4 h-4 text-primary shrink-0" /> Pay-per-token pricing</li>
          ...
          <div className="p-8 rounded-xl border border-border bg-card flex flex-col">
            ...
            <div className="text-4xl font-bold mb-6 font-mono text-2xl mt-2">Custom</div>
            <ul className="space-y-3 mb-8 flex-1 text-sm font-mono text-muted-foreground mt-2">
